...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.POST("/wechat/qrcode", middleware.CriticalRateLimit(), controller.WeChatGenerateQRCode)
		apiRouter.GET("/wechat/scan-status", controller.WeChatScanStatus)
		apiRouter.GET("/wechat/callback", controller.WeChatCallback)
		apiRouter.POST("/wechat/callback", controller.WeChatCallback)
		...
		apiRouter.POST("/alipay/webhook", controller.AliPayWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.POST("/topup/refund", middleware.CriticalRateLimit(), controller.UserRefundTopUp)
				...
				selfRoute.POST("/wechat-pay/pay", middleware.CriticalRateLimit(), controller.RequestWeChatPayPay)
				selfRoute.POST("/wechat-pay/amount", controller.RequestWeChatPayAmount)
				selfRoute.GET("/wechat-pay/status", controller.GetWeChatPayOrderStatus)
				...
				selfRoute.GET("/alipay/status", controller.GetAliPayOrderStatus)
